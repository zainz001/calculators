...
export default function EquityCalculatorPage() {
  ...
  return (
    <div
      className="font-sans min-h-screen relative pb-32 lg:pb-20 lg:py-10"
      style={{ background: "var(--theme-left-bg)", color: "var(--theme-text-primary)" }}
    >
      {/* --- MOBILE HEADER (below lg) --- */}
      <div className="lg:hidden pt-12 pb-4 px-5 max-w-xl mx-auto">
        ...
        <h1
          className="text-[34px] font-extrabold tracking-tight leading-none mb-4"
      ...
      <div className="max-w-[1200px] mx-auto lg:px-8 px-0">
        ...
        <div className="hidden lg:block mb-10 text-left">
          ...
          <h1
            className="text-4xl lg:text-[44px] font-extrabold mb-4 leading-tight tracking-tight"
            style={{ color: "var(--theme-text-primary)" }}
          >
            See what your home could help <br />
        ...
        {/* --- MOBILE HERO TEXT (below lg) --- */}
        <div className="lg:hidden bg-white px-5 pt-8 pb-10">
          <p
          ...
          <h2
            className="text-[28px] font-bold leading-[1.2] mb-4 tracking-tight"
            style={{ color: "var(--theme-text-primary)" }}
          >
        ...
        {/* --- MAIN GRID --- */}
        {/* Single column below lg, two-column grid at lg+ */}
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-0 lg:gap-8 mb-0 lg:mb-16">

          {/* Results column — top on mobile, right on desktop */}
          <div className="order-1 lg:order-2 lg:col-span-7 flex flex-col gap-0 lg:gap-6">
            <ResultsSection results={results} propertyType={propertyType} />

            <div className="px-5 lg:px-0 -mt-6 lg:mt-0 relative z-10">
              <WealthBar
                homeValue={homeValue}
                mortgage={mortgage}
                savings={savings}
            ...
            {/* Desktop CTA */}
            <div
              className="hidden lg:flex p-8 rounded-[24px] text-white flex-row items-center justify-between gap-6 shadow-lg"
            ...
            >
              <div className="max-w-md">
                ...
                <p className="text-sm text-white/90 leading-relaxed">
                  Book a free, no-obligation chat with a Staircase adviser. We'll walk through your
                  numbers, structure, and what's realistically next.
                </p>
              </div>
              <button
          ...
          {/* Inputs column — middle on mobile, left on desktop */}
          <div className="order-2 lg:order-1 lg:col-span-5 px-5 lg:px-0 mt-6 lg:mt-0">
            <div className="bg-white p-6 lg:p-8 rounded-[20px] lg:rounded-[24px] shadow-[0_2px_15px_rgba(0,0,0,0.03)] lg:shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
              <InputSection
                homeValue={homeValue}
        ...
        <p
          className="hidden lg:block text-[11px] mt-8 max-w-4xl leading-relaxed"
          style={{ color: "var(--theme-text-secondary)" }}
        >
      ...
      {/* --- MOBILE STICKY CTA (below lg) --- */}
      <div
        className="lg:hidden fixed bottom-0 left-0 right-0 p-5 z-50 flex justify-center pointer-events-none"
